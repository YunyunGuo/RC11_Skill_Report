...
public class allControllermedium : MonoBehaviour
{
    ...
    void GetAgentType()
    {
        GameObject parentobject = GameObject.Find("AgentTypesmedium");
    ...
    {
        GameObject parentobject = GameObject.Find("SpawnLocationmedium");
        SpawnLocationType = parentobject.transform.childCount;
    ...
    void SpawnAgents()
    {
        ...
        int m = Random.Range(0, SpawnLocationType);
