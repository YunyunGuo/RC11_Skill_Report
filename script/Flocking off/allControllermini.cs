...
public class allControllermini : MonoBehaviour
{
    ...
    void GetAgentType()
    {
        GameObject parentobject = GameObject.Find("AgentTypesmini");
    ...
    {
        GameObject parentobject = GameObject.Find("SpawnLocationmini");
