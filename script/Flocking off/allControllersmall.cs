...
public class allControllersmall : MonoBehaviour
{
    ...
    void GetAgentType()
    {
        GameObject parentobject = GameObject.Find("AgentTypessmall");
    ...
    {
        GameObject parentobject = GameObject.Find("SpawnLocationsmall");
